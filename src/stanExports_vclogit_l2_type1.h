...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 95, column 2 to column 59)",
                                                      " (in 'string', line 60, column 2 to column 16)",
                                                      " (in 'string', line 61, column 2 to column 14)",
                                                      " (in 'string', line 62, column 9 to column 13)",
                                                      " (in 'string', line 62, column 15 to column 16)",
                                                      " (in 'string', line 62, column 2 to column 27)",
                                                      " (in 'string', line 64, column 2 to column 44)",
                                                      " (in 'string', line 66, column 4 to line 67, column 49)",
                                                      " (in 'string', line 68, column 6 to column 24)",
                                                      " (in 'string', line 69, column 6 to column 20)",
                                                      " (in 'string', line 65, column 22 to line 70, column 3)",
                                                      " (in 'string', line 65, column 2 to line 70, column 3)",
                                                      " (in 'string', line 75, column 8 to column 33)",
                                                      " (in 'string', line 74, column 29 to line 76, column 7)",
                                                      " (in 'string', line 74, column 6 to line 76, column 7)",
                                                      " (in 'string', line 73, column 22 to line 77, column 5)",
                                                      " (in 'string', line 73, column 4 to line 77, column 5)",
                                                      " (in 'string', line 78, column 4 to column 47)",
                                                      " (in 'string', line 72, column 17 to line 79, column 3)",
                                                      " (in 'string', line 72, column 2 to line 79, column 3)",
                                                      " (in 'string', line 84, column 4 to column 44)",
                                                      " (in 'string', line 82, column 22 to line 85, column 3)",
                                                      " (in 'string', line 82, column 2 to line 85, column 3)",
                                                      " (in 'string', line 87, column 2 to column 47)",
                                                      " (in 'string', line 88, column 2 to line 89, column 41)",
...
public:
  ...
  inline std::string model_name() const final { return "model_vclogit_l2_type1"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_vclogit_l2_type1_namespace::log_prob";
(void) function__;  // suppress unused var warning
...
(void) function__;  // suppress unused var warning
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"beta\",\"type\":{\"name\":\"array\",\"length\":" << ncatm1 << ",\"element_type\":{\"name\":\"vector\",\"length\":" << K << "}},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"vector\",\"length\":" << Q << "},\"block\":\"parameters\"},{\"name\":\"nu_raw\",\"type\":{\"name\":\"matrix\",\"rows\":" << Q << ",\"cols\":" << J << "},\"block\":\"parameters\"},{\"name\":\"L\",\"type\":{\"name\":\"matrix\",\"rows\":" << Q << ",\"cols\":" << Q << "},\"block\":\"parameters\"},{\"name\":\"nu\",\"type\":{\"name\":\"matrix\",\"rows\":" << J << ",\"cols\":" << Q << "},\"block\":\"transformed_parameters\"},{\"name\":\"Sigma\",\"type\":{\"name\":\"matrix\",\"rows\":" << Q << ",\"cols\":" << Q << "},\"block\":\"generated_quantities\"}]";
    return s__.str();
    } // get_constrained_sizedtypes() 
    
  inline std::string get_unconstrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"beta\",\"type\":{\"name\":\"array\",\"length\":" << ncatm1 << ",\"element_type\":{\"name\":\"vector\",\"length\":" << K << "}},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"vector\",\"length\":" << Q << "},\"block\":\"parameters\"},{\"name\":\"nu_raw\",\"type\":{\"name\":\"matrix\",\"rows\":" << Q << ",\"cols\":" << J << "},\"block\":\"parameters\"},{\"name\":\"L\",\"type\":{\"name\":\"vector\",\"length\":" << ((Q * (Q - 1)) / 2) << "},\"block\":\"parameters\"},{\"name\":\"nu\",\"type\":{\"name\":\"matrix\",\"rows\":" << J << ",\"cols\":" << Q << "},\"block\":\"transformed_parameters\"},{\"name\":\"Sigma\",\"type\":{\"name\":\"matrix\",\"rows\":" << Q << ",\"cols\":" << Q << "},\"block\":\"generated_quantities\"}]";
    return s__.str();
