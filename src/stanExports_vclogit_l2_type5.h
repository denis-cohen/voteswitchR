...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 89, column 8 to line 91, column 41)",
...
public:
  ...
  inline std::string model_name() const final { return "model_vclogit_l2_type5"; }
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_vclogit_l2_type5_namespace::log_prob";
(void) function__;  // suppress unused var warning
              ...
              ((rvalue(log_prob,
                ...
                rvalue(nu_elections,
                  cons_list(index_uni(election_id[(j - 1)]),
                    cons_list(index_uni(c), nil_index_list())),
                  "nu_elections")), "assigning variable log_prob");}}
