...
static constexpr std::array<const char*, 107> locations_array__ =
  ...
  " (in 'string', line 107, column 2 to column 93)",
  " (in 'string', line 61, column 2 to column 37)",
  " (in 'string', line 62, column 2 to column 69)",
  ...
  " (in 'string', line 76, column 8 to column 66)",
  ...
  " (in 'string', line 101, column 2 to column 50)",
  ...
  " (in 'string', line 55, column 16 to column 27)",
  ...
  " (in 'string', line 60, column 21 to column 27)",
...
public:
  ...
  model_vclogit_l2_type2(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_vclogit_l2_type2_namespace::model_vclogit_l2_type2";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_vclogit_l2_type2_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_vclogit_l2_type2_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    if (emit_transformed_parameters__) {
      std::vector<std::string> temp{"nu", "nu_parties"};
      names__.reserve(names__.size() + temp.size());
      names__.insert(names__.end(), temp.begin(), temp.end());
    }
    if (emit_generated_quantities__) {
      std::vector<std::string> temp{"Sigma", "Sigma_parties"};
      names__.reserve(names__.size() + temp.size());
      names__.insert(names__.end(), temp.begin(), temp.end());
    }
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_params__ = (((((((ncatm1 * K) + Q) + (Q * J)) + (Q * Q))
      + ncatm1) + (ncatm1 * num_parties)) + (ncatm1 * ncatm1));
