...
namespace model_vclogit_l2_type4_namespace {
...
static constexpr std::array<const char*, 107> locations_array__ =
  ...
  " (in 'string', line 76, column 8 to column 70)",
...
class model_vclogit_l2_type4 final : public model_base_crtp<model_vclogit_l2_type4> {
private:
  int ncat;
  int K;
  int J;
...
public:
  ~model_vclogit_l2_type4() {}
  model_vclogit_l2_type4(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_vclogit_l2_type4_namespace::model_vclogit_l2_type4";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_vclogit_l2_type4_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_vclogit_l2_type4_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    if (emit_transformed_parameters__) {
      std::vector<std::string> temp{"nu", "nu_countries"};
      names__.reserve(names__.size() + temp.size());
      names__.insert(names__.end(), temp.begin(), temp.end());
    }
    if (emit_generated_quantities__) {
      std::vector<std::string> temp{"Sigma", "Sigma_countries"};
      names__.reserve(names__.size() + temp.size());
      names__.insert(names__.end(), temp.begin(), temp.end());
    }
  }
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"beta\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(ncatm1) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "}},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(Q) + "},\"block\":\"parameters\"},{\"name\":\"nu_raw\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(Q) + ",\"cols\":" + std::to_string(J) + "},\"block\":\"parameters\"},{\"name\":\"L\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(Q) + ",\"cols\":" + std::to_string(Q) + "},\"block\":\"parameters\"},{\"name\":\"sigma_countries\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(ncatm1) + "},\"block\":\"parameters\"},{\"name\":\"nu_raw_countries\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(ncatm1) + ",\"cols\":" + std::to_string(num_countries) + "},\"block\":\"parameters\"},{\"name\":\"L_countries\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(ncatm1) + ",\"cols\":" + std::to_string(ncatm1) + "},\"block\":\"parameters\"},{\"name\":\"nu\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(J) + ",\"cols\":" + std::to_string(Q) + "},\"block\":\"transformed_parameters\"},{\"name\":\"nu_countries\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(num_countries) + ",\"cols\":" + std::to_string(ncatm1) + "},\"block\":\"transformed_parameters\"},{\"name\":\"Sigma\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(Q) + ",\"cols\":" + std::to_string(Q) + "},\"block\":\"generated_quantities\"},{\"name\":\"Sigma_countries\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(ncatm1) + ",\"cols\":" + std::to_string(ncatm1) + "},\"block\":\"generated_quantities\"}]");
  }
  inline std::string get_unconstrained_sizedtypes() const {
    return std::string("[{\"name\":\"beta\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(ncatm1) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "}},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(Q) + "},\"block\":\"parameters\"},{\"name\":\"nu_raw\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(Q) + ",\"cols\":" + std::to_string(J) + "},\"block\":\"parameters\"},{\"name\":\"L\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(((Q * (Q - 1)) /2)) + "},\"block\":\"parameters\"},{\"name\":\"sigma_countries\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(ncatm1) + "},\"block\":\"parameters\"},{\"name\":\"nu_raw_countries\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(ncatm1) + ",\"cols\":" + std::to_string(num_countries) + "},\"block\":\"parameters\"},{\"name\":\"L_countries\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(((ncatm1 * (ncatm1 - 1)) /2)) + "},\"block\":\"parameters\"},{\"name\":\"nu\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(J) + ",\"cols\":" + std::to_string(Q) + "},\"block\":\"transformed_parameters\"},{\"name\":\"nu_countries\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(num_countries) + ",\"cols\":" + std::to_string(ncatm1) + "},\"block\":\"transformed_parameters\"},{\"name\":\"Sigma\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(Q) + ",\"cols\":" + std::to_string(Q) + "},\"block\":\"generated_quantities\"},{\"name\":\"Sigma_countries\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(ncatm1) + ",\"cols\":" + std::to_string(ncatm1) + "},\"block\":\"generated_quantities\"}]");
  }
...
using stan_model = model_vclogit_l2_type4_namespace::model_vclogit_l2_type4;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_vclogit_l2_type4_namespace::profiles__;
}
#endif
#endif
