...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 82, column 8 to column 70)",
                                                      ...
                                                      " (in 'string', line 59, column 16 to column 29)",
...
public:
  ...
  inline std::string model_name() const final { return "model_vclogit_l2_type4"; }
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.26.1-1-g67504470", "stancflags = "};
  }
  
  
  model_vclogit_l2_type4(stan::io::var_context& context__,
    ...
    static const char* function__ = "model_vclogit_l2_type4_namespace::model_vclogit_l2_type4";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    static const char* function__ = "model_vclogit_l2_type4_namespace::log_prob";
(void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    vars__.resize(0);
    stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
    static const char* function__ = "model_vclogit_l2_type4_namespace::write_array";
(void) function__;  // suppress unused var warning
    (void) function__;  // suppress unused var warning
    double lp__ = 0.0;
  ...
  inline std::string get_constrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"beta\",\"type\":{\"name\":\"array\",\"length\":" << ncatm1 << ",\"element_type\":{\"name\":\"vector\",\"length\":" << K << "}},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"vector\",\"length\":" << Q << "},\"block\":\"parameters\"},{\"name\":\"nu_raw\",\"type\":{\"name\":\"matrix\",\"rows\":" << Q << ",\"cols\":" << J << "},\"block\":\"parameters\"},{\"name\":\"L\",\"type\":{\"name\":\"matrix\",\"rows\":" << Q << ",\"cols\":" << Q << "},\"block\":\"parameters\"},{\"name\":\"sigma_countries\",\"type\":{\"name\":\"vector\",\"length\":" << ncatm1 << "},\"block\":\"parameters\"},{\"name\":\"nu_raw_countries\",\"type\":{\"name\":\"matrix\",\"rows\":" << ncatm1 << ",\"cols\":" << num_countries << "},\"block\":\"parameters\"},{\"name\":\"L_countries\",\"type\":{\"name\":\"matrix\",\"rows\":" << ncatm1 << ",\"cols\":" << ncatm1 << "},\"block\":\"parameters\"},{\"name\":\"nu\",\"type\":{\"name\":\"matrix\",\"rows\":" << J << ",\"cols\":" << Q << "},\"block\":\"transformed_parameters\"},{\"name\":\"nu_countries\",\"type\":{\"name\":\"matrix\",\"rows\":" << num_countries << ",\"cols\":" << ncatm1 << "},\"block\":\"transformed_parameters\"},{\"name\":\"Sigma\",\"type\":{\"name\":\"matrix\",\"rows\":" << Q << ",\"cols\":" << Q << "},\"block\":\"generated_quantities\"},{\"name\":\"Sigma_countries\",\"type\":{\"name\":\"matrix\",\"rows\":" << ncatm1 << ",\"cols\":" << ncatm1 << "},\"block\":\"generated_quantities\"}]";
    return s__.str();
    } // get_constrained_sizedtypes() 
    
  inline std::string get_unconstrained_sizedtypes() const {
    stringstream s__;
    s__ << "[{\"name\":\"beta\",\"type\":{\"name\":\"array\",\"length\":" << ncatm1 << ",\"element_type\":{\"name\":\"vector\",\"length\":" << K << "}},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"vector\",\"length\":" << Q << "},\"block\":\"parameters\"},{\"name\":\"nu_raw\",\"type\":{\"name\":\"matrix\",\"rows\":" << Q << ",\"cols\":" << J << "},\"block\":\"parameters\"},{\"name\":\"L\",\"type\":{\"name\":\"vector\",\"length\":" << ((Q * (Q - 1)) / 2) << "},\"block\":\"parameters\"},{\"name\":\"sigma_countries\",\"type\":{\"name\":\"vector\",\"length\":" << ncatm1 << "},\"block\":\"parameters\"},{\"name\":\"nu_raw_countries\",\"type\":{\"name\":\"matrix\",\"rows\":" << ncatm1 << ",\"cols\":" << num_countries << "},\"block\":\"parameters\"},{\"name\":\"L_countries\",\"type\":{\"name\":\"vector\",\"length\":" << ((ncatm1 * (ncatm1 - 1)) / 2) << "},\"block\":\"parameters\"},{\"name\":\"nu\",\"type\":{\"name\":\"matrix\",\"rows\":" << J << ",\"cols\":" << Q << "},\"block\":\"transformed_parameters\"},{\"name\":\"nu_countries\",\"type\":{\"name\":\"matrix\",\"rows\":" << num_countries << ",\"cols\":" << ncatm1 << "},\"block\":\"transformed_parameters\"},{\"name\":\"Sigma\",\"type\":{\"name\":\"matrix\",\"rows\":" << Q << ",\"cols\":" << Q << "},\"block\":\"generated_quantities\"},{\"name\":\"Sigma_countries\",\"type\":{\"name\":\"matrix\",\"rows\":" << ncatm1 << ",\"cols\":" << ncatm1 << "},\"block\":\"generated_quantities\"}]";
    return s__.str();
