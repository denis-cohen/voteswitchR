...
#include "stanExports_vclogit_l2_type2.h"

RCPP_MODULE(stan_fit4vclogit_l2_type2_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_vclogit_l2_type2")
