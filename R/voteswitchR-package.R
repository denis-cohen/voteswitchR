...
#' For data processing:
#' \enumerate{
#'   \item \code{\link{build_data_file}}: Harmonize, impute, map, rake, and aggregate vote switching data
...
#'   \item \code{\link{calculate_pred_error}}: Calculate the MAEs and RMSEs of MAVCL Predictions
