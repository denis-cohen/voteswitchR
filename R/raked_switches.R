#' Rake-weighted cell counts for all idiosyncratic transition matrices
#'
#' Rake-weighted cell counts for the raw, idiosyncratic transition matrices of
#' all elections included in \code{voteswitchR}.
#'
#' @format A data frame with 21409 rows and 5 columns. \code{elec_id} gives the
