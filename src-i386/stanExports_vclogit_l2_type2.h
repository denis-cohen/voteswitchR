...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_vclogit_l2_type2");
    reader.add_event(129, 127, "end", "model_vclogit_l2_type2");
    return reader;
}
...
class model_vclogit_l2_type2
  : public stan::model::model_base_crtp<model_vclogit_l2_type2> {
private:
        int ncat;
        int K;
        int J;
            ...
            for (int c = 1; c <= ncatm1; ++c) {
                ...
                for (int j = 1; j <= J; ++j) {
                    ...
                    stan::model::assign(log_prob, 
                                ...
                                (get_base1(log_prob, c, j, "log_prob", 1) + get_base1(nu_parties, get_base1(party_id, j, "party_id", 1), c, "nu_parties", 1)), 
                                "assigning variable log_prob");
                }
            }
...
typedef model_vclogit_l2_type2_namespace::model_vclogit_l2_type2 stan_model;
#ifndef USING_R
